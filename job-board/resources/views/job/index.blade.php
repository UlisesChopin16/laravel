<x-layout>
    ...
    :links="['Jobs' => route('offered_jobs.index')]" />
    <x-card class="mb-4 text-sm" x-data="">
    <form x-ref="filters" id="filtering-form" action="{{ route('offered_jobs.index') }}" method="GET">
      <div class="mb-4 grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <div class="flex space-x-2">
            <text-input name="min_salary" value="{{ request('min_salary') }}"
        ...
        <div>
          ...
          <x-radio-group name="category"
            :options="\App\Models\OfferedJob::$categories" />
        </div>
      </div>
